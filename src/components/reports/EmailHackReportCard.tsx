...
import { Mail, Calendar, ChevronRight, Upload, AlertCircle, Shield, AlertTriangle } from 'lucide-react';
import { useRouter } from 'next/navigation';

interface EmailHackReportCardProps {
...
export const EmailHackReportCard = ({ 
  report, 
  isExpanded, 
  onToggle,
  getStatusColor 
}: EmailHackReportCardProps) => {
  ...
  return (
    <Card className="overflow-hidden border-l-4 border-l-emerald-500 hover:shadow-lg transition-all duration-200">
