...
import { MapPin, Calendar, ChevronRight, Upload, AlertCircle, Shield, AlertTriangle } from 'lucide-react';
import { useRouter } from 'next/navigation';

interface LocationTrackingReportCardProps {
...
export const LocationTrackingReportCard = ({ 
  report, 
  isExpanded, 
  onToggle,
  getStatusColor 
}: LocationTrackingReportCardProps) => {
  ...
  return (
    <Card className="overflow-hidden border-l-4 border-l-amber-500 hover:shadow-lg transition-all duration-200">
