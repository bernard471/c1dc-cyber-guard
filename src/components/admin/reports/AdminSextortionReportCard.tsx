...
import { AlertTriangle, Calendar, ChevronRight, Download, AlertCircle, Shield } from 'lucide-react';
...
interface AdminSextortionReportCardProps {
...
export const AdminSextortionReportCard = ({ 
  report, 
  isExpanded, 
  onToggle,
  getStatusColor,
  onStatusUpdate
}: AdminSextortionReportCardProps) => {
