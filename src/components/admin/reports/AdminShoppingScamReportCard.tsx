...
import { ShoppingBag, Calendar, ChevronRight, Download, AlertCircle, Shield, AlertTriangle } from 'lucide-react';
...
interface AdminShoppingScamReportCardProps {
...
export const AdminShoppingScamReportCard = ({ 
  report, 
  isExpanded, 
  onToggle,
  getStatusColor,
  onStatusUpdate
}: AdminShoppingScamReportCardProps) => {
  ...
  return (
    <>
    <Card className="overflow-hidden mb-6 border-l-4 border-l-rose-500 hover:shadow-lg transition-all duration-200">
