...
import { AlertCircle, Calendar, ChevronRight, Download, MapPin, Phone, User, Shield } from 'lucide-react';
...
interface AdminEmergencyReportCardProps {
...
export const AdminEmergencyReportCard = ({ 
  report, 
  isExpanded, 
  onToggle,
  getStatusColor,
  onStatusUpdate,
}: AdminEmergencyReportCardProps) => {
