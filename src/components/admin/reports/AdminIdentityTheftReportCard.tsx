...
import { UserX, Calendar, ChevronRight, Download, AlertCircle, Shield, AlertTriangle } from 'lucide-react';
...
interface AdminIdentityTheftReportCardProps {
...
export const AdminIdentityTheftReportCard = ({ 
  report, 
  isExpanded, 
  onToggle,
  getStatusColor,
  onStatusUpdate
}: AdminIdentityTheftReportCardProps) => {
