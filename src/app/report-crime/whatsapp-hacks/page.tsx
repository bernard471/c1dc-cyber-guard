...
import { WhatsAppHackForm } from '@/components/crime-forms/WhatsAppHackForm'
...
export default function WhatsAppHackReportPage() {
  const [activeTab, setActiveTab] = useState('whatsapp-hack');
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="max-w-6xl mx-auto p-6">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Report WhatsApp Hack 💬</h1>
            <p className="mt-2 text-gray-600">
              Please provide detailed information about the WhatsApp hack incident
            </p>
          </div>
